...
-- CreateEnum
CREATE TYPE "ContractStatus" AS ENUM ('AWAITING_SIGNATURE', 'CONTRACT_SIGNED', 'SENT_TO_NOTARY', 'LOAN_OFFER_PENDING', 'LOAN_OFFER_RECEIVED', 'LOAN_OFFER_SENT_TO_NOTARY', 'NOTARY_APPOINTMENT_SCHEDULED');
...
-- CreateEnum
CREATE TYPE "ProspectStatus" AS ENUM ('NEW', 'CONTACTED', 'QUALIFIED', 'OPTIONED', 'CONVERTED', 'DROPPED');
