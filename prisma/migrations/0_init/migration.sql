...
-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('PENDING_EMAIL', 'PENDING_ASSOCIATION', 'ACTIVE', 'SUSPENDED', 'DELETION_REQUESTED', 'NO_ACCOUNT');
...
CREATE TABLE "Lot" (
    ...
    "notes" TEXT,
    "building" TEXT,
    "annexSurface" DECIMAL(8,2),
    "garden" DECIMAL(8,2),
    "suv" DECIMAL(8,2),
    "priceNetVendeur" DECIMAL(12,2),
    "priceNetVendeurWithParking" DECIMAL(12,2),
    "commissionAgence" DECIMAL(12,2),
    "commissionAgenceParking" DECIMAL(12,2),
    "priceLocation" DECIMAL(12,2),
    "creditImpot35" DECIMAL(12,2),
    "priceRevientCrdImp" DECIMAL(12,2),
...
CREATE TABLE "Dossier" (
    ...
    "observation" TEXT,
    "financingMode" TEXT,
    "kbisObtainedAt" TIMESTAMP(3),
    "clientAtRsm" BOOLEAN,
    "reservationSignedAt" TIMESTAMP(3),
    "deposit200ReceivedAt" TIMESTAMP(3),
    "guaranteeDepositAmount" DECIMAL(12,2),
    "guaranteeDepositReceivedAt" TIMESTAMP(3),
    "rarSentByNotaryAt" TIMESTAMP(3),
    "loanFiledAt" TIMESTAMP(3),
    "loanObtainedAt" TIMESTAMP(3),
